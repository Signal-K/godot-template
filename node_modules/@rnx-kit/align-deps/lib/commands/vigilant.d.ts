 ...
 */
export declare function checkPackageManifestUnconfigured(manifestPath: string, options: Options, config: AlignDepsConfig, logError?: (message?: any, ...optionalParams: any[]) => void): ErrorCode;
export {};
